...
def cafe_com_leite():
    print("A bebida escolhida foi o café com leite")
    bebida_cafe_com_leite = 1.20
    ...
    preco_total_bebidas = bebida_cafe_com_leite * int(quantidade_bebida)
    ...
    for contador in range(0, valor):
        ...
        while verifica == False:
            ...
            if valor_moedas == "1":
                dinheiro_total += Decimal("0.10")
                verifica = True
            elif valor_moedas == "2":
                dinheiro_total += Decimal("0.50")
                verifica = True
            elif valor_moedas == "3":
                dinheiro_total += Decimal("1.0")
                verifica = True
            else:
                print(
    ...
    if dinheiro_total >= preco_total_bebidas:
        ...
        print(f"O preço do produto é de {bebida_cafe_com_leite:.2f}")
